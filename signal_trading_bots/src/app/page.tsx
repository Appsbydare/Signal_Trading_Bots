...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section - Full Screen (LIGHT) */}
      <section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white min-h-screen overflow-hidden flex items-start">
          ...
          <div className="space-y-8 w-full max-w-6xl text-left">
            ...
            >
              ...
              <motion.p
                ...
                className="text-[0.9rem] md:text-base lg:text-lg text-[var(--text-muted)] max-w-5xl leading-relaxed mt-4"
              >
            ...
            >
              <Link
                href="/products"
                className="rounded-md bg-[var(--brand-blue)] px-6 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-[var(--brand-blue-deep)] hover:scale-105 hover:shadow-lg"
              >
                View Products
              </Link>
              <Link
                href="/specs"
                className="rounded-md border border-[var(--border-subtle)] px-6 py-3 text-sm font-medium text-[var(--text-main)] transition hover:border-[var(--brand-blue-soft)] hover:text-[var(--brand-blue-deep)]"
              >
                View Specs
              </Link>
              <Link
                href="#how-it-works"
                className="rounded-md border border-[var(--border-subtle)] px-6 py-3 text-sm font-medium text-[var(--text-main)] transition hover:border-[var(--brand-blue-soft)] hover:text-[var(--brand-blue-deep)] scroll-smooth"
                onClick={(e) => {
                  e.preventDefault();
