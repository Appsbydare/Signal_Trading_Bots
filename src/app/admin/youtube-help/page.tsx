  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
        <h1 className="text-2xl font-semibold tracking-tight text-white">YouTube Help Files Admin</h1>
        <p className="mt-1 text-sm text-zinc-400">Manage YouTube help content for the application</p>
      </div>
