    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-3 rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
        ...
        <div className="flex-1">
          <h3 className="font-semibold text-blue-300 text-sm uppercase tracking-wide">Verify Your Email</h3>
          <p className="mt-1 text-xs text-blue-200">
            We've sent a 6-digit code to <strong className="text-blue-100">{email}</strong>
          </p>
        </div>
      </div>
