                                        ...
                                        <div className="relative w-[62px] h-[62px] flex-shrink-0">
                                            ...
                                            <div className="w-full h-full rounded-2xl overflow-hidden shadow-sm relative">
                                                <Image
                                                    ...
                                                    sizes="62px"
                                                />
                                                {/* Inset Thick Border Overlay to ensure it's visible on top of the image */}
                                                <div className="absolute inset-0 border-[3px] border-slate-200/80 rounded-2xl pointer-events-none" />
                                            </div>
                                            {/* Quality Badge */}
                                            <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-1 shadow-md border border-slate-100 z-10">
