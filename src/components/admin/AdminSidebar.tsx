...
export function AdminSidebar() {
    ...
    return (
        <div className="flex h-full w-64 flex-col border-r border-zinc-800 bg-zinc-900/50 backdrop-blur-xl">
            <div className="flex h-16 items-center gap-2 border-b border-zinc-800 px-6">
                <div className="relative h-8 w-auto">
                    <Image
                        src="/Tradingbot.png"
                        alt="Signal Trading Bot"
                        width={32}
                        height={32}
            ...
            <div className="border-t border-zinc-800 p-4">
                <div className="rounded-md bg-zinc-900/50 p-3">
                    <p className="text-xs font-medium text-zinc-500">Logged in as Admin</p>
                </div>
            </div>
        </div>
    );
